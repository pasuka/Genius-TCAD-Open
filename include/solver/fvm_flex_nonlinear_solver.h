...
#ifndef __fvm_flex_nonlinear_solver_h__
#define __fvm_flex_nonlinear_solver_h__
...
/**
 * The flex nonlinear solver contex.
 */
class FVM_FlexNonlinearSolver : public FVM_FlexPDESolver
{
public:
   ...
   * constructor
   */
  FVM_FlexNonlinearSolver(SimulationSystem & system);


  /**
   * destructor
   */
  virtual ~FVM_FlexNonlinearSolver();
   ...
   */
  void eigen_value_of_jacobian_matrix(int n=1, int i=0, Vec = PETSC_NULLPTR, int j=0, Vec = PETSC_NULLPTR);
...
protected:
  ...
  /**
   *  wrap of jacobian matrix
   */ 
  SparseMatrix<PetscScalar> * Jac; 
...
#endif // #define __fvm_flex_nonlinear_solver_h__
